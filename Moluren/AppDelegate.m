...
//        //self.window.rootViewController = lanuchVC;
//        [self performSelector:@selector(enterMainView) withObject:nil afterDelay:0];
//    //}
...
//    
//    // Override point for customization after application launch.
//    CurrentHistoryPage *rootViewController = [[CurrentHistoryPage alloc] init];
...
-(void)enterMainView{
    ...
    //UITabBarItem *item1 = [[UITabBarItem alloc] initWithTitle:@"聊天" image:nil tag:1];
    /*UITabBarItem *item1 = [[UITabBarItem alloc] initWithTabBarSystemItem:UITabBarSystemItemFeatured tag:1];*/
    /*[item1 setFinishedSelectedImage:[UIImage imageNamed:@"SettingsIconSelected"]
        withFinishedUnselectedImage:[UIImage imageNamed:@"ChatIcon"]];*/
    UITabBarItem *item1 = [[UITabBarItem alloc] initWithTitle:@"聊天" image:[[UIImage imageNamed:@"ChatIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"ChatIconSelected"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    viewController1.tabBarItem = item1;
    viewController1.title = @"聊天";
    ...
    //chatNavigation.navigationBar.tintColor = [UIColor blueColor];
    [chatNavigation.navigationBar
     setTitleTextAttributes:@{NSForegroundColorAttributeName : [UIColor whiteColor]}];
    [chatNavigation.navigationBar setBarTintColor:UIColorFromRGB(0x0067A8)];
    
    viewController2 = [[MolurenHistoryViewController alloc] initWithNibName:nil bundle:nil];
    viewController2.title = @"记录";
    
    /*UITabBarItem *item2 = [[UITabBarItem alloc] initWithTitle:@"记录" image:nil tag:2];
    [item2 setFinishedSelectedImage:[UIImage imageNamed:@"HistoryIconSelected"]
        withFinishedUnselectedImage:[UIImage imageNamed:@"HistoryIcon"]];*/
    UITabBarItem *item2 = [[UITabBarItem alloc] initWithTitle:@"记录" image:[[UIImage imageNamed:@"HistoryIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"HistoryIconSelected"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    ...
    [historyNavigation.navigationBar
     setTitleTextAttributes:@{NSForegroundColorAttributeName : [UIColor whiteColor]}];
    [historyNavigation.navigationBar setBarTintColor:UIColorFromRGB(0x0067A8)];
    ...
    /*[item3 setFinishedSelectedImage:[UIImage imageNamed:@"SettingsIconSelected"]
        withFinishedUnselectedImage:[UIImage imageNamed:@"SettingsIcon"]];*/
    UITabBarItem *item3 = [[UITabBarItem alloc] initWithTitle:@"设置" image:[[UIImage imageNamed:@"SettingsIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"SettingsIconSelected"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    ...
    [settingNavigation.navigationBar
     setTitleTextAttributes:@{NSForegroundColorAttributeName : [UIColor whiteColor]}];
    [settingNavigation.navigationBar setBarTintColor:UIColorFromRGB(0x0067A8)];
    ...
    [UITabBarItem.appearance setTitleTextAttributes:
     @{NSForegroundColorAttributeName : UIColorFromRGB(0x09bb07)}
