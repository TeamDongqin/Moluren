...
//                                                 buttonSize);
    ...
    multiMediaSendBut.frame = CGRectMake(horizontalPadding,
                                                 verticalPadding,
                                                 buttonSize,
                                                 buttonSize);
   /*
    self.multiMediaSendButton = [[UIButton alloc] initWithFrame:CGRectMake(horizontalPadding,
                                                                            verticalPadding,
                                                                            buttonSize,
                                                                            buttonSize)];
    
    
    [self.multiMediaSendButton setBackgroundImage:[UIImage imageNamed:@"TypeSelectorBtn_Black_ios7@2x.png"] forState:UIControlStateNormal];*/
...
//            self.holdDownButton.frame = CGRectMake(horizontalPadding + buttonSize +5.0f,4.5f,CGRectGetWidth(self.bounds)- 3*buttonSize -2*horizontalPadding- 15.0f,buttonSize);
            ...
            self.holdDownButton.frame = CGRectMake(horizontalPadding + buttonSize +5.0f,4.5f,CGRectGetWidth(self.bounds)- buttonSize -2*horizontalPadding- 10.0f,buttonSize);
