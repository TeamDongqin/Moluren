...
{
    id aClassInstance = [[[aClass alloc] init] autorelease];
    ...
    NSDictionary *propertyKeys = [[aClassInstance enumerateKeysInDictionary:dict] retain];
...
- (NSDictionary *)enumerateKeysInDictionary:(NSDictionary *)valueDict
{
    ...
    NSMutableDictionary *propertyKeys = [[[NSMutableDictionary alloc] init] autorelease];
