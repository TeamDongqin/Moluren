...
@interface ChatHistoryDBManager ()

@end

@implementation ChatHistoryDBManager

static ChatHistoryDBManager * _sharedDBManager;

+ (ChatHistoryDBManager *) defaultDBManager {
    if (!_sharedDBManager) {
        _sharedDBManager = [[ChatHistoryDBManager alloc] init];
    }
