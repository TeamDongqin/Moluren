...
@interface NewLanuchViewController ()

@end

@implementation NewLanuchViewController
...
- (void)showIntroWithCustomView {
    EAIntroPage *page1 = [EAIntroPage page];
    page1.title = @"陌路人,认识更多新朋友";
    page1.desc = @"    陌路人是一个在线认识新朋友的全新服务。当你登录 陌路人时，我们随机选取另外一个用户和你搭配一对一的聊天。整个对话是在匿名状态下进行的，当然，这并不会限制你向你的陌生朋友透露你的联系方式以获取更进一步的联络。 ";
    page1.bgImage = [UIImage imageNamed:@"1"];
    page1.titleImage = [UIImage imageNamed:@"original"];
    ...
    EAIntroPage *page3 = [EAIntroPage page];
    page3.title = @"警告";
    page3.desc = @"    礼貌聊天，文明交友。请遵守当地有关法律法规，不要撒播谣言，传播色情信息，以及发送垃圾信息干扰用户正常使用。";
    page3.bgImage = [UIImage imageNamed:@"3"];
    page3.titleImage = [UIImage imageNamed:@"femalecodertocat"];
...
- (void)showIntroWithSeparatePagesInit {
    ...
    EAIntroPage *page2 = [EAIntroPage page];
    page2.title = @"提醒";
    page2.desc = @"    我们无法规避如同现实社会中一样的社交风险！请不要随意相信陌生人，不要随意透露隐私信息、金融信息、敏感数据等。";
    page2.bgImage = [UIImage imageNamed:@"2"];
    page2.titleImage = [UIImage imageNamed:@"supportcat"];
...
-(void)enterMainView{
    ...
    [item1 setFinishedSelectedImage:[UIImage imageNamed:@"ChatIconSelected"]
