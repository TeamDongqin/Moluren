...
@interface Chat_Topic_Life () <JSMessagesViewDelegate, JSMessagesViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@implementation Chat_Topic_Life
...
- (void)loadView
{
    ...
    [[TdTopic Instance] SetCurrentTopic:Topic_Life];
}
...
//    [alert show];
    ...
    //ConfirmView* view = [[ConfirmView alloc] initWithFrame:CGRectMake(0, Device_Height - 168, Device_Width, 168)];
...
//    vc.view.frame = CGRectMake(0, Device_Height, Device_Width, 168);
//    vc.modalTransitionStyle = UIModalTransitionStyleCoverVertical;
//    
//    [self presentViewController:vc
//                       animated:YES
//                     completion:^(void){
//                         vc.view.frame = CGRectMake(0, Device_Height - 168, Device_Width, 168);
//                     }];
...
-(void)SessionConnectedCallback
{
    ...
    UIImage *PowerButtonBgImage = [UIImage imageNamed:@"TopicLife_PowerButton_On"];
...
-(void)receiveMessage{
    ...
    if(self.sharedConfig.isConnected && !self.sharedConfig.isReceivingMsg){
        if(self.sharedConfig.httpRequestTimeoutTimes>5 && self.sharedConfig.httpRequestTimeoutTimes%6==0){
            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"陌路人" message:@"抱歉，亲，'公园'内暂时没有遇到其他人，请回到大厅前往其他场景" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil];
            [alert show];
        }
